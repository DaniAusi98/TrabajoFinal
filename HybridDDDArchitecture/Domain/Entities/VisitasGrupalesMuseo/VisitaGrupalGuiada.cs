   ...
   public class VisitaGrupalGuiada: DomainEntity<int, VisitaGuiadaValidator>
    {
        ...
        public ActividadMuseo ActividadMuseo { get; private set; }   // composicion con la clase ActividadMuseo, que tiene el tipo de actividad, cantidad de personas, horarios, etc.
            ...
            )
        {
            ...
            ActividadMuseo = new ActividadMuseo(
