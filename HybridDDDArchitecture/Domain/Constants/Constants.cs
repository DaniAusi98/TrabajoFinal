...
namespace Domain.Constants
{
    public static class DomainConstants
    {
        ...
        public const string HALLINGRESO = "HallIngreso";
        public const string AUDITORIO = "Auditorio";
        public const string MUESTRASPERMANENTES = "MuestrasPermanentes";
        public const string BIBLIOTECA = "Biblioteca";

        public const string HALLINGRESO_CODIGO = "HALL-INGRESO";
        public const string SALASPERMANENTES_CODIGO = "SALA-MUESTRAS-PERMANENTES";
    }
}
