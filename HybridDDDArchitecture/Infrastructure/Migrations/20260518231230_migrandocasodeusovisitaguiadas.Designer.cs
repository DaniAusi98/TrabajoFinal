...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260518231230_migrandocasodeusovisitaguiadas")]
    partial class migrandocasodeusovisitaguiadas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DisponibilidadMuseo.Entities.ActividadMuseo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.DisponibilidadMuseo.Entities.RecursoAsignado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.VisitasMuseo.Entities.Guia.AusenciaGuia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AusenciaGuia");
                });

            modelBuilder.Entity("Domain.VisitasMuseo.Entities.Guia.Guia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.VisitasMuseo.Entities.Guia.HorarioGuia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.VisitasMuseo.Entities.TematicaVisita", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TematicaVisita");
                });

            modelBuilder.Entity("Domain.VisitasMuseo.Entities.VisitaGrupalGuiada", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("UsuarioVisitanteId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ActividadSala", b =>
                {
                    b.HasOne("Domain.DisponibilidadMuseo.Entities.ActividadMuseo", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.DisponibilidadMuseo.Entities.ActividadMuseo", b =>
                {
                    b.OwnsMany("Domain.CommonDomain.ValueObjets.TimeSlot", "TimeSlots", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.DisponibilidadMuseo.Entities.RecursoAsignado", b =>
                {
                    b.HasOne("Domain.DisponibilidadMuseo.Entities.ActividadMuseo", "Actividad")
                        .WithMany("Recursos")
            ...
            modelBuilder.Entity("Domain.VisitasMuseo.Entities.Guia.AusenciaGuia", b =>
                {
                    b.HasOne("Domain.VisitasMuseo.Entities.Guia.Guia", "Guia")
            ...
            modelBuilder.Entity("Domain.VisitasMuseo.Entities.Guia.HorarioGuia", b =>
                {
                    b.HasOne("Domain.VisitasMuseo.Entities.Guia.Guia", null)
            ...
            modelBuilder.Entity("Domain.VisitasMuseo.Entities.VisitaGrupalGuiada", b =>
                {
                    b.HasOne("Domain.DisponibilidadMuseo.Entities.ActividadMuseo", "ActividadMuseo")
                        .WithOne()
                        .HasForeignKey("Domain.VisitasMuseo.Entities.VisitaGrupalGuiada", "ActividadMuseoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Domain.CommonDomain.ValueObjets.Email", "EmailInstitucion", b1 =>
                        {
                    ...
                    b.OwnsOne("Domain.CommonDomain.ValueObjets.Telefono", "TelefonoInstitucion", b1 =>
                        {
                            b1.Property<int>("VisitaGrupalGuiadaId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("VisitaTematica", b =>
                {
                    b.HasOne("Domain.VisitasMuseo.Entities.TematicaVisita", null)
                        .WithMany()
                        .HasForeignKey("TematicaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.VisitasMuseo.Entities.VisitaGrupalGuiada", null)
                        .WithMany()
                        .HasForeignKey("VisitaGrupalGuiadaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
