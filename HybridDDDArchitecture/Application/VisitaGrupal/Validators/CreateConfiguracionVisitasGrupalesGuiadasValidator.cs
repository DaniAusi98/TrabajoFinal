...
{
    public class CreateConfiguracionVisitasGrupalesGuiadasValidator : AbstractValidator<CreateConfiguracionVisitasGrupalesGuiadasCommand>
    {
        public CreateConfiguracionVisitasGrupalesGuiadasValidator()
        {
